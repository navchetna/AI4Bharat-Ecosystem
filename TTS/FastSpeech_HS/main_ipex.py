...
class Text2SpeechApp:
    ...
    def convert_and_save(self, text: str, speaker_gender="male", output_file_dir: str = "./outputs"):
        ...
        for chunk_text in result_chunks:
            ...
            with torch.no_grad():
                ...
                audio = audio.cpu(torch.float32).numpy().astype('int16')
    ...
    def generate_audio_bytes(self, text: str, speaker_gender="male"):
            ...
            output_file = self.save_to_files(audio, file_prefix="generated_audio")
...
if __name__ == "__main__":
    ...
    result = tts.generate_audio_bytes(text="नीता अंबानी की डायमंड जूलरी में ईशा अंबानी लगीं खूबसूरत, देसी ग्लैमर से सबको किया इंप्रेस")
    print("This is the result: ", time.perf_counter() - st)
    print(result)
